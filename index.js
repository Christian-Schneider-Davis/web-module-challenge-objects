...
console.log(createMenuItem("pie", 20, "lunch"));
console.log(createMenuItem("cake", 20, "lunch"));
...
*/
reviews.push({
  name: "Christian", rating: 10000, feedback: "He's lit."});
console.log(reviews);
...
function getReviewByIndex(array, index) {
  ...
  let rating = currentObject.rating;
  let feedback = currentObject.feedback;
